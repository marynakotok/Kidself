...
public class GCMRegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationTokenToServer(final String token) {
        ...
        final String code_user = AppController.getInstance().getCodeUser();
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, URLs.URL_STORE_TOKEN + code_user,
